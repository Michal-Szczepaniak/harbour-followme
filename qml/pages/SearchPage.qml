	...
	SilicaListView {
		...
		delegate: FollowMeItem {
			...
			onClicked: {
				...
				entryItem.locator = [{id: entryItem.provider, label: entryItem.providerLabel}, {id:entryItem.id, label: entryItem.label, file:entryItem.file}];
                console.log(JSON.stringify(entryItem.locator));
